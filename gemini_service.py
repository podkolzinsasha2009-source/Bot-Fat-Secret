...
─── НАЗВАНИЯ ПРОДУКТОВ ─────────────────────────────────────────────
Передавай максимально ПРОСТОЕ и ОБЩЕЕ название продукта для поиска по базе.
НЕ добавляй бренд если он не важен: «молоко» а не «молоко лебедянское 3.2%».
НЕ добавляй «без сахара», «обезжиренный» если пользователь этого не говорил.
Примеры правильных имён: «сахар», «молоко», «гречка», «творог», «куриная грудка».
"""
