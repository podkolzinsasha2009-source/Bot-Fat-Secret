...
1. Логирование еды (нет слов: "измени", "исправь", "ошибка", "вместо", "удали"):
...
2. Удаление записи (слова: "удали", "убери", "удалить"):
{"type":"food","action":"delete_food","product_name":"точное название из рациона"}

3. Изменение веса (слова: "не X, а Y", "исправь вес", "было X теперь Y"):
{"type":"food","action":"change_weight","product_name":"название","new_weight":200}

4. Замена продукта (слова: "вместо", "неправильно", "ошибка", "исправь"):
...
стакан/кружка = 200г | тарелка = 300г | ложка столовая = 15г | ложка чайная = 5г
яйцо = 60г | кусочек хлеба = 30г | ломтик сыра = 20г | не указан = 100г
"""
