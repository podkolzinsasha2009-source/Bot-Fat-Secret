...
Если сказал «молоко лебедянское 3.2» → name: «молоко лебедянское 3.2»
Если сказал «творог 5%» → name: «творог 5%»
Если сказал просто «молоко» → name: «молоко»
Если сказал «сахар» → name: «сахар» (не «сахар-песок», не «epica без сахара»)
"""
